...
if (isset($_POST['picks_id']) and isset($_POST['picks_user_id']) and isset($_POST['correct_picks'])) {
    ...
    $query = "SELECT picks_id, picks_user_id FROM `tbl_player_picks` WHERE picks_id='$picks_id' and picks_user_id='$picks_user_id' ORDER BY picks_id DESC LIMIT 1";
    ...
    if ($count == 1) {
        // Edit picks
        $update_query = "UPDATE `tbl_player_picks` SET correct_picks='$correct_picks' WHERE picks_id='$picks_id' and picks_user_id='$picks_user_id'";
